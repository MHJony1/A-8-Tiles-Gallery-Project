...
export const generateMetadata = async ({ params }) => {
  ...
  if (!tilesDetails) {
    return {
      title: 'Tile Not Found | Premium Collection',
    };
  }

  return {
    title: `${tilesDetails.title} | Premium Tiles`,
  };
};
...
const getTileData = async (id) => {
  try {
    ...
    return allTiles.find((tile) => tile.id.toString() === id.toString());
  } catch (error) {
...
const TilesDetailsPage = async ({ params }) => {
  ...
  if (!tile) {
    return (
      <div className="h-screen flex flex-col items-center justify-center font-serif text-stone-400 uppercase tracking-widest gap-4">
        <p>Collection Not Found</p>
        <Link
          href="/all-tiles"
          className="text-xs text-amber-600 border-b border-amber-600 pb-1"
        >
          Back to Collections
        </Link>
      </div>
  ...
  return (
    <main className="min-h-screen bg-white text-[#121212] antialiased">
      <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-16 py-6 md:py-10">
        {/* Navigation Section */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8 md:mb-12">
          ...
          <div className="text-[9px] md:text-[10px] tracking-[0.3em] font-bold text-stone-300 uppercase">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-16 xl:gap-24 items-start">
          {/* Image Section - Fixed unoptimized issue */}
          <div className="lg:col-span-7 w-full">
            <div className="relative aspect-4/3 sm:aspect-5/4 bg-[#F9F9F9] overflow-hidden group border border-stone-100">
              ...
              />
              <div className="absolute bottom-4 right-4 md:bottom-8 md:right-8 p-3 md:p-4 bg-white/90 backdrop-blur shadow-2xl lg:opacity-0 lg:group-hover:opacity-100 transition-all">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="space-y-4 md:space-y-6">
              <div className="flex items-center gap-3">
                ...
                <span className="text-[9px] md:text-[10px] tracking-[0.3em] uppercase text-amber-600 font-bold">
            ...
            <div className="pt-2 pb-8 border-b border-stone-100">
              ...
              <div className="flex items-baseline gap-2 md:gap-3">
                ...
                <span className="text-4xl md:text-5xl font-medium tracking-tighter text-stone-900">
                  {tile.price}
                </span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-10">
              <div className="space-y-1">
                <p className="text-[8px] md:text-[9px] tracking-[0.2em] uppercase text-stone-400 font-bold">
                  Standard Size
                </p>
            ...
            <div className="pt-2">
              <button className="w-full bg-[#1A1A1A] hover:bg-amber-600 text-white py-5 px-8 flex items-center justify-between transition-all duration-300 group shadow-lg">
                <span className="text-[10px] md:text-xs tracking-[0.3em] uppercase font-bold">
                  Request Quotation
                </span>
                <ArrowRight
                  size={18}
