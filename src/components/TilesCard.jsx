  ...
  return (
    <div
      className="
        ...
        "
    >
      {/* ── Image — zero overlay, fully clean ── */}
      ...
      <div className="flex flex-col px-5 pt-5 pb-5 bg-[#111111]">
        <h3
          className="
                    text-[15px] font-semibold leading-snug tracking-wide
        ...
        >
          ...
          <div className="flex items-center">
            <span
              className="
                            block h-px bg-stone-700
                            w-6 group-hover/btn:w-10 group-hover/btn:bg-amber-500
                            transition-all duration-300
                        "
            />
            <HiOutlineArrowNarrowRight
              className="
                            text-base ml-0.5 text-stone-600
                            opacity-0 group-hover/btn:opacity-100
                            -translate-x-1 group-hover/btn:translate-x-0
                            transition-all duration-300 group-hover/btn:text-amber-400
                        "
            />
          </div>
        </button>
